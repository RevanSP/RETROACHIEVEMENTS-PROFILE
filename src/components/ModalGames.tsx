...
//                                 <div>
//                                     <p>
//                                         <strong>Developer :</strong> {gameInfo.Developer || 'N/A'}
//                                     </p>
//                                     <p>
//                                         <strong>Publisher :</strong> {gameInfo.Publisher || 'N/A'}
//                                     </p>
//                                     <p>
//                                         <strong>Genre :</strong> {gameInfo.Genre || 'N/A'}
//                                     </p>
//                                     <p>
//                                         <strong>Console :</strong> {gameInfo.ConsoleName || 'N/A'}
//                                     </p>
//                                     <p>
//                                         <strong>Released :</strong>{' '}
//                                         {gameInfo.Released ? new Date(gameInfo.Released).toLocaleDateString() : 'N/A'}
//                                     </p>
//                                     <p>
//                                         <strong>Number of Players :</strong> {gameInfo.NumDistinctPlayers || 'N/A'}
//                                     </p>
//                                     <p>
//                                         <strong>Achievements :</strong> {gameInfo.NumAchievements || 'N/A'}
//                                     </p>
//                                 </div>
//                             </div>
...
//                                                                     height="16"
//                                                                     fill="currentColor"
//                                                                     className="bi bi-x-circle-fill mx-auto"
//                                                                     viewBox="0 0 16 16"
//                                                                 >
//                                                                     <path
