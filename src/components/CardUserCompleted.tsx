                        ...
                        {currentGames.length > 0 ? (
                            currentGames.map((game) => (
                                <tr key={`${game.GameID}-${game.HardcoreMode}`} className="text-center">
                                    ...
                                    <td className="flex items-center justify-center text-center mt-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-4 bi bi-trophy-fill mr-2 text-yellow-500" viewBox="0 0 16 16">
